...
describe Export do
  let(:new) { described_class.new(cursor: cursor) }

  describe "when to csv" do
    let(:cursor) do
      [
    ...
    it "returns json csv format" do
      expect(new.to_csv).to eq(csv)
    end
  end

  describe "when column stacked" do
    let(:cursor) do
      [
    ...
    it "returns highchart column stacked format" do
      expect(new.to_column_stacked).to eq(column_stacked)
    end
  end
  ...
  describe "when column stacked grouped" do
    ...
    it "returns highchart column stacked  grouped format" do
      expect(new.to_column_stacked_grouped).to eq(column_stacked_grouped)
    end
  end

  describe "when to_column" do
    let(:cursor) do
      [
        { category: "cat1", serie: "ser1", value: 10, datestamp: 2014_10_01 },
        { category: "cat1", serie: "ser2", value: 9, datestamp: 2014_10_02 },
    ...
    it "return highchart column format" do
      expect(new.to_column).to eq(column)
    end
  end
  ...
  describe "when timeseries" do
    ...
    it "returns highchart timeseries format" do
      expect(new.to_timeseries).to eq(timeseries)
    end
  end

  describe "when to json_value" do
    describe "1 level" do
      let(:cursor) do
        [
      ...
      it "returns json_value format" do
        expect(new.to_json_value).to eq(json_value)
      end
    end
  ...
  describe "when to json_array" do
    describe "1 level" do
      ...
      it "returns json_value format" do
        expect(new.to_json_array).to eq(json_array)
      end
    end
  ...
  describe "when multiple csv" do
    ...
    it "returns the good json" do
      expect(new.to_multiple_csv).to eq(multiple_csv)
    end
  end

  describe "when to_value" do
    let(:cursor) { [{ my_value: 14 }, { my_value: 42 }] }
    let(:value) { { value: 42 } }

    it "returns the good json" do
      expect(new.to_value).to eq(value)
    end
  end
  ...
  describe "when leaflet" do
    ...
    it "return highchart column format" do
      expect(new.to_leaflet).to eq(leaflet)
    end
  end

  describe "when to_boxplot" do
    let(:cursor) do
      [
    ...
    it "return highchart boxplot format" do
      expect(new.to_boxplot).to eq(boxplot)
    end
  end

  describe "when to_small_heatmap" do
    let(:cursor) do
      [
    ...
    it "return highchart heatmap format" do
      expect(new.to_small_heatmap).to eq(small_heatmap)
    end
  end

  describe "when to_large_heatmap" do
    let(:cursor) do
      [
        { x_category: "cat1", y_category: "ser1", value: 1 },
        { x_category: "cat1", y_category: "ser2", value: 9 },
    ...
    it "return highchart heatmap format" do
      expect(new.to_large_heatmap).to eq(large_heatmap)
    end
  end
  ...
  describe "when to_scatter" do
    ...
    it "return scatter format" do
      expect(new.to_scatter).to eq(scatter)
    end
  end

  describe "when to_fixed_placement_column" do
    let(:cursor) do
      [
        { category: "cat1", serie: "ser1", value: 10 },
        { category: "cat1", serie: "ser2", value: 9 },
    ...
    it "return scatter format" do
      expect(new.to_fixed_placement_column).to eq(fixed_placement_column)
    end
  end
end
