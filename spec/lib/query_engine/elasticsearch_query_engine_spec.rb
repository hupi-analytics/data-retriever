  ...
  let(:filter_array) do
    {
      "sub_should" => [
        ...
        { operator: '{ "match": { "indicators": #_value_#, "boost": 1 } }', value: ["666", "221"], field: "indicators", value_type: "array" }
      ],
      "sub_and_function" => [
        { operator: '{ "gauss": { "proprio.location": { "origin": #_value_#, "offset": "50km", "scale": "25km" } }, "weight": 1}', value: '{"lat": 43.2, "lon": 1.2}', field: "proprio.geoloc", value_type: "hash" },
        { operator: '{ "gauss": { "vehicle.location": { "origin": #_value_#, "offset": "100km", "scale": "25km" } }, "weight": 1}', value: { "lat" => 43.2, "lon" => 1.2 }, field: "vehicle.geoloc", value_type: "hash" },
              ...
              query: {
                bool: {
                  should: [
                    ...
                    { match: { indicators: ["666", "221"], boost: 1 } }
                  ]
                },
                function_score: {
                  functions: [
